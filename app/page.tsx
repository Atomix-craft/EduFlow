          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 card-hover">
              ...
              <p className="text-gray-600">
                Optimized for speed with cloud infrastructure ensuring instant access to all features and data.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 card-hover">
              ...
              <p className="text-gray-600">
                Enterprise-grade security with GDPR compliance and data encryption to protect sensitive information.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 card-hover">
              ...
              <p className="text-gray-600">
                Intuitive interface designed for all skill levels with comprehensive training and support.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 card-hover">
              ...
              <p className="text-gray-600">
                Grows with your institution from small colleges to large universities with unlimited scalability.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 card-hover">
              ...
              <p className="text-gray-600">
                Powerful insights and reporting tools to make data-driven decisions for better outcomes.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 card-hover">
              ...
              <p className="text-gray-600">
                Approve and manage curriculum versions, define credits, handle subject overrides, and maintain NEP compliance.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 card-hover">
              ...
              <p className="text-gray-600">
                Complete admission management, semester promotion, back year handling, and curriculum change support.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 card-hover">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Timetable & Attendance</h3>
              <p className="text-gray-600">
                Automated timetable generation, conflict resolution, and comprehensive attendance tracking system.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 card-hover">
              ...
              <p className="text-gray-600">
                Complete exam scheduling, invigilator assignment, result management, and back paper handling.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 card-hover">
              ...
              <p className="text-gray-600">
                Comprehensive fee management, payment tracking, and financial reporting system.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 card-hover">
              ...
              <p className="text-gray-600">
                Comprehensive reports for academic performance, attendance, financials, and LMS usage analytics.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="portals" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Tailored experiences for administrators, students, and teachers with role-specific features and workflows.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 card-hover">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4 text-center">Admin Portal</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 card-hover">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4 text-center">Student Portal</h3>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-green-500 mt-0.5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 card-hover">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4 text-center">Teacher Portal</h3>
              <ul className="space-y-3 text-gray-600">
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-green-500 mt-0.5 mr-2 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
